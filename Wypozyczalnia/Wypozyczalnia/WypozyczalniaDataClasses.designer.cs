...
namespace Wypozyczalnia
{
	...
	public partial class Część : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<decimal> _Zamówienie_Zamówienie_ID;
    ...
    partial void OnZamówienie_Zamówienie_IDChanging(System.Nullable<decimal> value);
    ...
    partial void OnCzęść_IDChanged();
		...
		public System.Nullable<decimal> Zamówienie_Zamówienie_ID
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Część_ID", AutoSync=AutoSync.OnInsert, DbType="Decimal(28,0) NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		public Zamówienie Zamówienie
		{
			...
			set
			{
							...
							|| (this._Zamówienie.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Zamówienie_Zamówienie_ID = default(Nullable<decimal>);
					}
